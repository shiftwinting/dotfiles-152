...
-- base
    ...
    -- TODO
    --  add sources for C, sh, lua
    --  put config in own file, it'll take up a ton of space here
    use
    {
        ...
        config = function()
            require("null-ls").config({
                sources = { require("null-ls").builtins.diagnostics.pylint }
            })
            require("lspconfig")["null-ls"].setup { on_attach = require"lsp".onAttach }
        end
    }
